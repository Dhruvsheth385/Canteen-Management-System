...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/foodspot1.png" width="60" class="me-2" alt="FOODSPOT Logo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">KJ Somaiya College Of Engineering</h4>
            <p class="mt-2 mb-3 fw-normal h6 ">Department Of Computer Engineering</p>
            <p class="mb-3 fw-bold text-bold text-wrap">DVA</p>
            <h4 class="mt-2 mb-3 fw-normal ">Guide Name</h4><p class="mt-2 mb-3 fw-normal h6 "> Prof. Samruddhi Yadav </p>
