...
<head>
    ...
    <title>Add New Cuisine | FOODSPOT</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_shop_add.php" class="form-floating" enctype="multipart/form-data">
            <h2 class="mt-4 mb-3 fw-normal text-bold"><i class="bi bi-pencil-square me-2"></i>Add New Cuisine</h2>
            ...
            <div class="form-floating mb-2">
                <input type="text" class="form-control" id="shopname" placeholder="Cuisine Name" name="s_name" required>
                <label for="shopname">Cuisine Name</label>
            </div>
            <div class="form-floating mb-2">
            ...
            <div class="mb-2">
                <label for="formFile" class="form-label">Upload cuisine image</label>
                <input class="form-control" type="file" id="s_pic" name="s_pic" accept="image/*">
            </div>
            <button class="w-100 btn btn-success mb-3" name="add_confirm" type="submit">Add New Cuisine</button>
        </form>
    </div>
