...
<head>
    ...
    <title>Admin Dashboard | FOODSPOT</title>
</head>
...
<body class="d-flex flex-column">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <p class="lead fw-normal">Food ordering system of KJSCE</p></div>
    </div>
                    ...
                    <div class="card rounded-5 border-success p-2">
                        <div class="card-body">
                            ...
                            <p class="card-text my-2">
                                ...
                                Cusinie(s) in the system
                            </p>
                            <div class="text-end">
                                <a href="admin_shop_list.php" class="btn btn-sm btn-outline-dark">Go to Cusinie List</a>
                            </div>
                        </div>
                    </div>
                </a>
