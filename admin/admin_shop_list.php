...
<head>
    ...
    <title>Cuisine List | FOODSPOT</title>
</head>
    ...
    <div class="container p-2 pb-0" id="admin-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    <i class="bi bi-check-circle ms-2"></i>
                    <span class="ms-2 mt-2">Successfully Add new cuisine.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_shop_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">Failed to Add new cuisine.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_shop_list.php">X</a></span>
                </div>
            </div>
            ...
            <h2 class="pt-3 display-6">Cuisine List</h2>
            <form class="form-floating mb-3" method="GET" action="admin_shop_list.php">
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="admin_shop_add.php" class="btn btn-primary">Add new cuisine</a>
                    </div>
                </div>
            </form>
        </div>
